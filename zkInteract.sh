...
ROOT="0x2ebf589aa3d849d56a3257485a403392e739d782d14b5bf57de023be04963b9f"
PROOF_1="0x793b52ec15707df3a079b9bef9182e21cd445f1b169bcafad1115c4ab97b2010"
PROOF_2="0xfc19450a5dbe7ef4a90490449e69ce9c9d67497f2e8e4d521d4ff9850937b153"
...
TOKEN_ADDRESS=$(forge create src/SixSevenToken.sol:SixSevenToken --rpc-url http://127.0.0.1:8011 --private-key ${DEFAULT_ZKSYNC_LOCAL_KEY} --legacy --zksync | awk '/Deployed to:/ {print $3}' )
...
# Get message hash
MESSAGE_HASH=$(cast call ${AIRDROP_ADDRESS} "getEIP712MessageHash(address,uint256)(bytes32)" ${DEFAULT_ANVIL_ADDRESS} 25000000000000000000 --rpc-url http://127.0.0.1:8011)
...
# Split signature
SIGN_OUTPUT=$(forge script script/Interactions.s.sol:SplitSignature --sig "run(bytes)" "$CLEAN_SIGNATURE")
